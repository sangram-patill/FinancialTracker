...
<title>Financial Tracker-Income Report</title>
<!-- Meta -->
<meta charset="utf-8">
...
<div class="app-wrapper">
					<form name="incomereport" action="view_report.jsp" method="post">

		<div class="d-flex justify-content-center gap-4 mt-5">
				<div class="d-flex justify-content-center mt-5">
					<input type="hidden" name="UserID" value="<%= session.getAttribute("UserID") %>">
					<button  type="submit" name="submit" value="Total Income" class="btn btn-success text-light">View Full Report</button>
				</div>
				<div class="d-flex justify-content-center mt-5">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="modal-footer">
							...
							<button type="submit" name="submit" value="Total Datewise Income" class="btn btn-success text-light">View</button>
