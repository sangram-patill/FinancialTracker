				...
				<div
					...
					<div class="inner">
						<div class="app-card-body p-3 p-lg-4">
							<h3 class="mb-3">
								Welcome,
								<%=userFromDao.getFirstName()%></h3>
							<div class="row gx-5 gy-3">
								<div class="col-12 col-lg-9">

									<div>Welcome to Financial Tracker! Your personal
										companion for managing income, expenses, investments, loans,
										and more. Stay in control of your finances and plan for a
  ...
  <path fill-rule="evenodd"
			...
			<div class="row g-4 mb-4">
				...
				<script>
					...
					var remainingIncome = totalIncome - (totalExpense + totalInvestment);
