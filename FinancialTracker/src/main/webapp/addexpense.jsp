...
<body class="app">
	...
	<div class="app-wrapper">
				...
				<div class="modal-content">
					...
					<form action="EditExpenseServlet" method="POST">
						...
						<div class="modal-body">
							...
							<div class="d-flex justify-content-between mt-3">
								<label for="incomeMode">Payment Mode</label> 
								<select id="incomeMode" name="incomeMode">
									<option value="Online"
		...
		<div id="message" style="display: none; text-align: center; margin-bottom: 2%; font-size: 16px;">
			No match found &#128546;	
		</div>
